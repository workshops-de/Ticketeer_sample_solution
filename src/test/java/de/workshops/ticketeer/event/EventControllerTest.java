...
class EventControllerTest {
    ...
    @Test
    void patchEventStatus_Ok() throws Exception {
        when(eventRepository.findById(2L)).thenReturn(
            Optional.ofNullable(Event.builder()
                .id(2L)
                .name("Jazz Festival")
                .venue("Park B")
        ...
        when(eventRepository.save(ArgumentMatchers.any(Event.class))).thenReturn(
            Event.builder()
                .id(2L)
                .name("Jazz Festival")
                .venue("Park B")
    ...
    @Test
    void patchEventStatus_invalidTransition() throws Exception {
        when(eventRepository.findById(2L)).thenReturn(
            Optional.ofNullable(Event.builder()
                .id(2L)
                .name("Jazz Festival")
