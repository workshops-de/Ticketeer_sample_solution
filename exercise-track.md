...
4. Use the defaultCurrency property in your repository (e.g. include defaultCurrency in event
   responses).
...
1. Configure **PostgreSQL** datasource via application.yml:
    * spring.datasource.url, username, password (using environment variables or, alternatively, via
...
3. Configure security:
    ...
    * Organizer endpoints require authentication (e.g. HTTP Basic or form login with in-memory
      users).
